...
## ===== Paths =====
file_path <- "E:/NTU_INTERN/Zhang Na/20251003 Calcium imaging_LCIS/ALL - Delta F divide F 3_chudi.xlsx"
...
# Condition A（PGE2）
groups_A <- "G:/NTU_INTERN/Zhang Na/20250829 Calcium imaging all the responsve neurons/thr0p15_k5/ALL_OnsetGroups_manual_5_10_25_sorted_thr0p15_k5.xlsx"
onset_A  <- "G:/NTU_INTERN/Zhang Na/20250829 Calcium imaging all the responsve neurons/thr0p15_k5/ALL_OnsetTimes_skip5_thr0p15_k5.xlsx"
label_A  <- "Wide type"            # legend display name
# col_A    <- "#F28E2B"       # orange
col_A <- "#000000"

# Condition B（Ptger3^{flox/flox}） - 4
groups_B <- "G:/NTU_INTERN/Zhang Na/20250829 Calcium imaging all the responsve neurons_2/ALL_OnsetGroups_manual_5_10_25_sorted_thr0p15_k5.xlsx"
onset_B  <- "G:/NTU_INTERN/Zhang Na/20250829 Calcium imaging all the responsve neurons_2/ALL_OnsetTimes_skip5_thr0p15_k5.xlsx"
...
# Condition B
groups_B <- "G:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/LCIS/ALL_OnsetGroups_manual_5_10_25_sorted_thr0p15_k5.xlsx"
onset_B  <- "G:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/LCIS/ALL_OnsetGroups_manual_5_10_25_sorted_thr0p15_k5.xlsx"
label_B  <- "LCIS"
col_B    <- "#000000"

# Condition C
groups_C <- "G:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/L-798106/ALL_OnsetGroups_manual_5_10_25_sorted_thr0p15_k5.xlsx"
onset_C  <- "G:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/L-798106/ALL_OnsetGroups_manual_5_10_25_sorted_thr0p15_k5.xlsx"
label_C  <- "L-798106"
col_C    <- "#4AC818"

# Output directory
out_dir  <- "G:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/merged_panels_sorted"
...
# PGE2 data (grouped)
data_A <- read_excel("G:/NTU_INTERN/Zhang Na/20250829 Calcium imaging all the responsve neurons/All the responsve neurons 4.xlsx")
onset_A <- read_excel("G:/NTU_INTERN/Zhang Na/20250829 Calcium imaging all the responsve neurons/thr0p15_k5/ALL_OnsetTimes_skip5_thr0p15_k5.xlsx")
label_A <- "PGE2"
col_A <- "#F28E2B"

# LCIS data (mean)
# data_B <- read_excel("E:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/LCIS/LCIS 2.xlsx")
data_B <- read_excel("G:/NTU_INTERN/Zhang Na/20251003 Calcium imaging_LCIS/ALL - Delta F divide F 3_chudi.xlsx")
label_B <- "LCIS"
col_B <- "#000000"
...
# Save
# out_dir <- "E:/NTU_INTERN/Zhang Na/PLOT/20250829 3merge_line/merged_panels"
out_dir <- "G:/NTU_INTERN/Zhang Na/PLOT/20251004/merged_panels"
